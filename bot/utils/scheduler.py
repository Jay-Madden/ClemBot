...
class Scheduler:
    ...
    def schedule_at(self, callback: t.Awaitable, *, time: datetime,) -> int:
    ...
    def schedule_in(self, callback: t.Awaitable, *, time: t.Union[int, float]) -> int:
    ...
    def cancel(self, task_id):
        try:
            self._scheduled_tasks[task_id].close()
        except KeyError:
    ...
    def _schedule(self, time, coro: t.Awaitable):
        ...
        self._scheduled_tasks[task_id] = coro
        return task_id
